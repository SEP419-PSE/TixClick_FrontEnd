...
//       // Prepare the eventDTO object according to the API documentation
//       const eventDTO = {
//         eventId: selectedEvent.eventId,
//         eventName: editFormData.eventName || selectedEvent.eventName,
//         location: editFormData.location || selectedEvent.location,
//         locationName: editFormData.locationName || selectedEvent.locationName,
//         startDate: editFormData.startDate || selectedEvent.startDate,
//         endDate: editFormData.endDate || selectedEvent.endDate,
//         status: editFormData.status || selectedEvent.status,
//         typeEvent: editFormData.typeEvent || selectedEvent.typeEvent,
//         description: editFormData.description || selectedEvent.description,
//         categoryId: editFormData.categoryId || selectedEvent.categoryId,
//         logoURL: editFormData.logoURL || selectedEvent.logoURL,
//         bannerURL: editFormData.bannerURL || selectedEvent.bannerURL,
//         urlOnline: editFormData.urlOnline || selectedEvent.urlOnline,
//       }

//       // Call the API with the correct structure
//       const response = await managerApi.updateEvent(eventDTO)
//       console.log("✅ Updated successfully:", response)

//       if (response.data && response.data.code === 0) {
//         // Update the events list with the edited event
//         const updatedEvents = events.map((event) =>
//           event.eventId === selectedEvent.eventId ? { ...event, ...response.data.result } : event,
//         )
...
//         if (isEventModalOpen) {
//           setSelectedEvent({ ...selectedEvent, ...response.data.result })
//         }
...
//                     <div className="max-h-[200px] overflow-y-auto pr-2 text-sm leading-relaxed whitespace-pre-wrap rounded bg-[#1E1E1E] p-3">
...
//             <div className="grid grid-cols-4 items-center gap-4">
//               <Label htmlFor="urlOnline" className="text-right">
//                 Online URL
//               </Label>
//               <Input
//                 id="urlOnline"
//                 className="col-span-3 bg-[#1E1E1E] text-white"
//                 value={editFormData.urlOnline || ""}
//                 onChange={(e) => setEditFormData({ ...editFormData, urlOnline: e.target.value })}
//               />
//             </div>
...
//               </Label>
//               <Select
//                 value={editFormData.typeEvent || ""}
//                 onValueChange={(value) => setEditFormData({ ...editFormData, typeEvent: value })}
//               >
...
//               Cancel
//             </Button>
//             <Button onClick={handleUpdateEvent} disabled={isProcessing} className="bg-blue-600 hover:bg-blue-700">
//               {isProcessing ? (
//                 <>
//                   <Loader2 className="w-4 h-4 mr-2 animate-spin" />
//                   Saving...
